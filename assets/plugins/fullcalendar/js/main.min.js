...
var FullCalendar = (function (e) {
    ...
    if (
      ...
      "o" === t[0] && "n" === t[1]
        ? ((a = t !== (t = t.replace(/Capture$/, ""))),
          ...
          n
            ? (r || e.addEventListener(t, x, a), ((e.l || (e.l = {}))[t] = n))
      ...
      return (
        ...
        (e.prototype.addEvent = function (e, t) {
          ...
          if (s) {
            ...
            return (
              this.dispatch({ type: "ADD_EVENTS", eventStore: Pt(s) }),
  ...
  var Xn = (function () {
      ...
      return (
        ...
        (e.prototype.diffWholeMonths = function (e, t) {
          var n = this.calendarSystem;
          return _e(e) === _e(t) && n.getMarkerDay(e) === n.getMarkerDay(t)
            ? n.getMarkerMonth(t) -
                n.getMarkerMonth(e) +
        ...
        (e.prototype.toDate = function (e, t) {
          return "local" === this.timeZone
            ...
            ? new Date(
                e.valueOf() -
                  1e3 * this.namedTimeZoneImpl.offsetForArray(ke(e)) * 60
              )
  ...
  function gr(e, t) {
    return (
      void 0 === t && (t = "day"), JSON.stringify({ date: tt(e), type: t })
    );
  }
  var mr,
    yr = null;
  ...
  var Br = (function (e) {
    ...
    return (
      ...
      (t.prototype.shouldComponentUpdate = function (e, t) {
        return (
          this.debug && console.log(We(e, this.props), We(t, this.state)),
          ...
          for (var m in u) {
            ...
            for (var T = i.eventStore, k = 0, M = S.allows; k < M.length; k++) {
              var x = M[k],
                ...
                P = T.instances[m],
                N = void 0;
              if (((N = I ? new zn(t, I, P) : new zn(t, D)), !x(_n(_, t), N)))
                return !1;
            }
          }
          return !0;
      ...
      return (
        ...
        (t.prototype.renderInnerContent = function () {
          var e = this.context.pluginHooks.contentTypeHandlers,
            ...
            o = null;
          if (
            (void 0 === r && (r = mo(t.defaultContent, t.hookProps)),
            void 0 !== r)
          ) {
  ...
  function vo() {
    ...
    return function (r, o) {
      return (
        (t && Le(t, o) && r === e) || ((e = r), (t = o), (n = go(r, o))), n
      );
    };
  }
  function go(e, t) {
  ...
  var Co = (function () {
    ...
    return (
      ...
      (e.prototype.adjustActiveRange = function (e) {
        ...
        return (
          r &&
            ...
            Je(i) > 1 && ((s = ve((s = be(s)), -1)), (s = n.add(s, i)))),
          { start: a, end: s }
        );
      }),
      ...
      (e.prototype.buildDateIncrement = function (e) {
        ...
        return (
          n ||
          ((t = this.props.dateAlignment) ? Ye(1, t) : e || Ye({ days: 1 }))
        );
      }),
    ...
    io({
      ...
      propSetHandlers: {
        dateProfile: function (e, t) {
          t.emitter.trigger(
            "datesSet",
            r(r({}, Tn(e.activeRange, t.dateEnv)), { view: t.viewApi })
          );
        },
    ...
    function e(e) {
      ...
      var s,
        ...
        c =
          ((s = o.calendarOptions),
          (l = o.dateEnv),
          null != (u = s.initialDate) ? l.createMarker(u) : Wn(s.now, l)),
      ...
      return (
        ...
        (t.prototype.renderWidgetGroup = function (e) {
          for (
            ...
            if ("title" === c)
              (a = !1),
                i.push(Hr("h2", { className: "fc-toolbar-title" }, t.title));
            else {
  ...
  var Pi = (function () {
      function e(e, t) {
        for (var n = e.start, r = e.end, o = [], i = [], a = -1; n < r; )
          t.isHiddenDay(n) ? o.push(a + 0.5) : (a++, o.push(a), i.push(n)),
            (n = ve(n, 1));
      ...
      return (
        ...
        (e.prototype.sliceNowDate = function (e, t) {
          ...
          return this._sliceDateSpan.apply(
            this,
            o([{ range: { start: e, end: ge(e, 1) }, allDay: !1 }, {}, t], n)
          );
        }),
        ...
        (this.masterCallback = e),
          ...
          (this.handleValue = function (e, n) {
            ...
            null !== e
              ...
              : 0 == --o[n] && (delete i[n], delete t.callbackMap[n], (a = !0)),
              t.masterCallback &&
    ...
    return (
      ...
      (t.prototype.render = function () {
        ...
        return Hr(
          ...
          Boolean(!h && d.length) && Hr.apply(void 0, o(["thead", {}], d)),
          Boolean(!h && p.length) && Hr.apply(void 0, o(["tbody", {}], p)),
          Boolean(!h && f.length) && Hr.apply(void 0, o(["tfoot", {}], f)),
      ...
      (t.prototype.renderSection = function (e, t, n) {
        return "outerContent" in e
          ...
          : Hr(
              "tr",
              { key: e.key, className: Zi(e, this.props.liquid).join(" ") },
  ...
  function ua(e) {
    return (
      e.event.title && Hr("div", { className: "fc-event-title" }, e.event.title)
    );
  }
  var ca = function (e) {
    return Hr(zr.Consumer, null, function (t) {
                ...
                function (t, n, i, a) {
                  return (
                    ...
                    Hr(
                      ...
                      Hr(Ei, r({ isHeightAuto: i, forPrint: a }, e))
                    )
                  );
                }
              ),
    ...
    ga = (function () {
      function e(e) {
        ...
        (this.subjectEl = null),
          ...
          ha++ || window.addEventListener("touchmove", ma, { passive: !1 });
      }
      return (
        (e.prototype.destroy = function () {
          this.containerEl.removeEventListener(
            ...
            --ha ||
              window.removeEventListener("touchmove", ma, { passive: !1 });
        }),
        (e.prototype.tryStart = function (e) {
          var t = this.querySubjectEl(e),
            n = e.target;
          return (
            !(!t || (this.handleSelector && !V(n, this.handleSelector))) &&
            ((this.subjectEl = t),
            (this.isDragging = !0),
            (this.wasTouchScroll = !1),
            !0)
        ...
        (e.prototype.handleMove = function (e, t) {
          if (this.isEnabled) {
            ...
            o < 0
              ...
              this.isAnimating ||
                ((this.isAnimating = !0), this.requestAnimation(ba()));
          }
        }),
  ...
  function ka(e, t) {
    return (
      (!e && !t) || (Boolean(e) === Boolean(t) && Rn(e.dateSpan, t.dateSpan))
    );
  }
  function Ma(e, t) {
    for (
            ...
            if (e) {
              ...
              i === a || (p.editable && p.droppable)
                ? (s = (function (e, t, n) {
                  ...
                  ((l = Pn(n, a.getCurrentData().eventUiBases, s, a)),
                  (c.mutatedEvents = l),
        ...
        void 0 === t && (t = {}),
          (this.handlePointerDown = function (e) {
            var t = n.dragging,
              ...
              i = r.longPressDelay;
            (t.minDistance =
              null != o ? o : e.isTouch ? 0 : bt.eventDragMinDistance),
        ...
        (t.prototype.render = function () {
          ...
          return Hr(
            ...
            Hr(
              ...
              Hr("span", { className: "fc-popover-title" }, t.title),
              Hr("span", {
          ...
          return (
            ...
            Hr(
              "div",
              {
                className: [
                  "fc-daygrid-body",
                  v ? "fc-daygrid-body-balanced" : "fc-daygrid-body-unbalanced",
    ...
    vs = (function () {
      ...
      return (
        ...
        (e.prototype.computeDateTop = function (e, t) {
          return (
            t || (t = be(e)), this.computeTimeTop(Ye(e.valueOf() - t.valueOf()))
          );
        }),
        ...
        return (
          ...
          (t.renderHeadAxis = function (e) {
            ...
            var n = t.context.options,
              ...
              a =
                n.navLinks && 1 === i
                  ? { "data-navlink": gr(o.start, "week"), tabIndex: 0 }
                  : {};
              ...
              chunks: [
                {
                  ...
                  rowContent: function (e) {
                    return Hr(
                      "tr",
                      null,
                      s.renderHeadAxis(e.rowSyncHeights[0])
                    );
                  },
                },
                {
                  ...
                  content: function (e) {
                    return Hr(
                      ...
                      Hr(
                        ...
                        e.tableColGroupNode,
                        Hr("tbody", null, Hr(Ts, { slatMetas: i }))
                      ),
                      Hr(
                        "div",
                        { className: "fc-timegrid-now-indicator-container" },
                        Hr(Mi, { unit: h ? "minute" : "day" }, function (e) {
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return (
            ...
            Hr(
              ea,
              r({}, this.props, { defaultTimeFormat: Os, extraClassNames: e })
            )
          );
        }),
        t
                ...
                r(
                  {
                    ...
                    isCondensed:
                      e.bottom - e.top < di.timeGridEventCondensedHeight,
                  },
          ...
          if (i.slatCoords) {
            ...
            var a = e.map(function (e) {
              return Hr(
                ...
                "bg-event" === t
                  ? Hr(la, r({ seg: e }, Sn(e, i.todayRange, i.nowDate)))
                  : sa(t)
              );
            });
            return Hr(Ur, null, a);
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return Hr(
            ...
            function (e, t) {
              return (
                t && Hr("div", { className: "fc-timegrid-col-misc", ref: e }, t)
              );
            }
          );
        }),
  ...
  function Xs(e) {
    ...
    return Hr(
      ...
      e.sideText &&
        Hr("a", r({ className: "fc-list-day-side-text" }, t), e.sideText)
    );
  }
  ...
  function nl(e) {
    for (
      var t = be(e.renderRange.start), n = e.renderRange.end, r = [], o = [];
      t < n;
