...
if (path[3] === "" || path[3].includes("index")) {
  setTimeout(() => {
    document.getElementById("index").classList.add("mm-active");
  }, 0);
}
if (path[3].includes("add-user")) {
  setTimeout(() => {
    document.getElementById("representative").classList.add("mm-active");
  }, 0);
}
if (path[3].includes("create-route")) {
  setTimeout(() => {
    document.getElementById("route").classList.add("mm-active");
    document.getElementById("croute").classList.add("mm-active");
  }, 0);
}
